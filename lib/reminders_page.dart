                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Get a gentle nudge to record a win.",
            ...
            Padding(
              ...
              child: Column(
                children: List.generate(
                  _messages.length,
                  (index) => _buildMessageOption(index),
                ),
              ),
            ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? primaryNeon : Colors.grey[200]!,
            width: 2,
          ),
        ),
        child: Row(
          children: [
            Icon(
              ...
              color: isSelected ? primaryNeon : Colors.grey[300],
            ),
